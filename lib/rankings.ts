...
// Weekly Top 3 / Bottom 3 performers now live in lib/weekly-rankings.ts —
// calendar-week-based (Monday-Sunday, Sunday-night archival, historical
// record), superseding the trailing-7-day version that used to live here.
